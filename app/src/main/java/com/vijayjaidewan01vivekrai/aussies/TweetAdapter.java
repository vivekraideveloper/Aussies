...
/**
 * Created by MR VIVEK RAI on 05-06-2018.
 */

public class TweetAdapter extends RecyclerView.Adapter<TweetAdapter.ImageViewHolder> {

    private Context context;
    private List<Upload> list;
    private TweetAdapter.OnItemClickListener mListener;

    public TweetAdapter(Context context, List<Upload> list){
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new TweetAdapter.ImageViewHolder(view);
    }
