 ...
 */
public class BlogsAdapter extends RecyclerView.Adapter<BlogsAdapter.ImageViewHolder> {

    private Context context;
    private List<Upload> list;
    private BlogsAdapter.OnItemClickListener mListener;

    public BlogsAdapter(Context context, List<Upload> list){
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new BlogsAdapter.ImageViewHolder(view);
    }
